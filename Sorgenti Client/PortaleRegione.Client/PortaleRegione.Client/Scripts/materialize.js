...
M.checkWithinContainer = function(container, bounding, offset) {
    ...
    var containerBottom = container === document.body
...
(function(r) {
    ...
    function y(a) {
        if (a =
            /([\+\-]?[0-9#\.]+)(%|px|pt|em|rem|in|cm|mm|ex|ch|pc|vw|vh|vmin|vmax|deg|rad|turn)?$/.exec(a)) return a[2];
    }
    ...
    function R(a, c, d, b) {
        var f = "delay" === a;
        return c.length
            ? (f ? Math.min : Math.max).apply(Math,
                c.map(function(b) {
                    return b[a];
                }))
            : f
    ...
    function q(a) {
        ...
        function b(a) {
            for (var b = 0, c = {}, d = g.animations, f = d.length; b < f;) {
                ...
                (l = r(h,
                    ...
                    l);
                for (var h = Math.min(Math.max(a - l.start - l.delay, 0), l.duration) / l.duration,
            ...
            if (b = Object.keys(c).length)
                for (d = 0; d < b; d++) {
                    H || (H = E(document.body, "transform") ? "transform" : "-webkit-transform"), g.animatables[d]
                        .target.style[H] = c[d].join(" ");
                }
            g.currentTime = a;
        ...
        function k(a) {
            ...
            (g.remaining
                ...
                : (g.pause(), g.completed ||
                    (g.completed = !0, f("complete"), "Promise" in window && (p(), m = c()))), l = 0);
        }
    ...
    var ga = {
        ...
        Q = function() {
            ...
            var c = "Quad Cubic Quart Quint Sine Expo Circ Back Elastic".split(" "),
                d = {
                    In: [
                        [.55, .085, .68, .53], [.55, .055, .675, .19], [.895, .03, .685, .22], [.755, .05, .855, .06],
                        [.47, 0, .745, .715], [.95, .05, .795, .035], [.6, .04, .98, .335], [.6, -.28, .735, .045], a
                    ],
                    Out: [
            ...
            [
                {
                    ...
                    value: function init(els, options) {
                        return _get(Collapsible.__proto__ || Object.getPrototypeOf(Collapsible), "init", this)
...
(function($, anim) {
    ...
    var Dropdown = function(_Component2) {
        ...
        function Dropdown(el, options) {
            ...
            var _this9 = _possibleConstructorReturn(this,
            ...
            [
                {
                    ...
                    value: function _getDropdownPosition() {
                        ...
                        var alignments = M.checkPossibleAlignments(this.el,
            ...
            [
                {
                    key: "init",
                    value: function init(els, options) {
                        return _get(Dropdown.__proto__ || Object.getPrototypeOf(Dropdown), "init", this)
                            .call(this, this, els, options);
                    }
...
(function($, anim) {
    ...
    var Modal = function(_Component3) {
        ...
        function Modal(el, options) {
            ...
            var _this13 = _possibleConstructorReturn(this,
            ...
            [
                {
                    key: "init",
                    value: function init(els, options) {
                        return _get(Modal.__proto__ || Object.getPrototypeOf(Modal), "init", this)
                            .call(this, this, els, options);
                    }
            ...
            [
                {
                    key: "init",
                    value: function init(els, options) {
                        return _get(Materialbox.__proto__ || Object.getPrototypeOf(Materialbox), "init", this)
                            .call(this, this, els, options);
                    }
...
(function($) {
    ...
    var Parallax = function(_Component5) {
        ...
        function Parallax(el, options) {
            ...
            var _this21 = _possibleConstructorReturn(this,
            ...
            [
                {
                    key: "init",
                    value: function init(els, options) {
                        return _get(Parallax.__proto__ || Object.getPrototypeOf(Parallax), "init", this)
                            .call(this, this, els, options);
                    }
...
(function($, anim) {
    ...
    var Tabs = function(_Component6) {
        ...
        function Tabs(el, options) {
            ...
            var _this22 = _possibleConstructorReturn(this,
            ...
            [
                {
                    key: "init",
                    value: function init(els, options) {
                        return _get(Tabs.__proto__ || Object.getPrototypeOf(Tabs), "init", this)
                            .call(this, this, els, options);
                    }
...
(function($, anim) {
    ...
    var Tooltip = function(_Component7) {
        ...
        function Tooltip(el, options) {
            ...
            var _this26 = _possibleConstructorReturn(this,
            ...
            [
                {
                    ...
                    value: function _positionTooltip() {
                        ...
                        newCoordinates =
                            this._repositionWithinScreen(targetLeft, targetTop, tooltipWidth, tooltipHeight);
                        $(tooltip).css({
            ...
            [
                {
                    key: "init",
                    value: function init(els, options) {
                        return _get(Tooltip.__proto__ || Object.getPrototypeOf(Tooltip), "init", this)
                            .call(this, this, els, options);
                    }
...
(function($, anim) {
    ...
    var Sidenav = function(_Component8) {
        ...
        function Sidenav(el, options) {
            ...
            var _this31 = _possibleConstructorReturn(this,
            ...
            [
                {
                    key: "init",
                    value: function init(els, options) {
                        return _get(Sidenav.__proto__ || Object.getPrototypeOf(Sidenav), "init", this)
                            .call(this, this, els, options);
                    }
...
(function($, anim) {
    ...
    var ScrollSpy = function(_Component9) {
        ...
        function ScrollSpy(el, options) {
            ...
            var _this35 = _possibleConstructorReturn(this,
            ...
            [
                {
                    key: "init",
                    value: function init(els, options) {
                        return _get(ScrollSpy.__proto__ || Object.getPrototypeOf(ScrollSpy), "init", this)
                            .call(this, this, els, options);
                    }
...
(function($) {
    ...
    var Autocomplete = function(_Component10) {
        ...
        function Autocomplete(el, options) {
            ...
            var _this37 = _possibleConstructorReturn(this,
            ...
            [
                {
                    ...
                    value: function selectOption(el) {
                        //MATCAT - CUSTOMIZE MATERIALIZE PER SUPPORTARE 'ID' IN AUTOCOMPLETE 
                        var id = el.attr("persona_id");
                        ...
                        if (typeof this.options.onAutocomplete === "function") {
                            this.options.onAutocomplete.call(this, text, id);
                        }
                    }
                    ...
                    value: function _renderDropdown(data, val) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            var trovato = false;
                            if(data[i].tag.toLowerCase().indexOf(val) !== -1)
                                trovato = true
                            if (trovato) {
                                var entry = {
                                    data: data[i].id,
                        ...
                        if (this.options.sortFunction) {
                            var sortFunctionBound = function(a, b) {
                                return _this39.options.sortFunction(a.key.toLowerCase(),
                                    b.key.toLowerCase(),
                                    val.toLowerCase());
                            };
                        ...
                        for (var i = 0; i < matchingData.length; i++) {
                            ...
                            var $autocompleteOption = $("<li persona_id='" + _entry.data + "'></li>");
                            if (!!_entry.data) {
            ...
            [
                {
                    key: "init",
                    value: function init(els, options) {
                        return _get(Autocomplete.__proto__ || Object.getPrototypeOf(Autocomplete), "init", this)
                            .call(this, this, els, options);
                    }
...
(function($, anim) {
    ...
    var Slider = function(_Component11) {
        ...
        function Slider(el, options) {
            ...
            var _this40 = _possibleConstructorReturn(this,
            ...
            [
                {
                    ...
                    value: function start() {
                        clearInterval(this.interval);
                        this.interval = setInterval(this._handleIntervalBound,
            ...
            [
                {
                    key: "init",
                    value: function init(els, options) {
                        return _get(Slider.__proto__ || Object.getPrototypeOf(Slider), "init", this)
                            .call(this, this, els, options);
                    }
...
(function($) {
    ...
    var Chips = function(_Component12) {
        ...
        function Chips(el, options) {
            ...
            var _this45 = _possibleConstructorReturn(this,
            ...
            [
                {
                    ...
                    value: function _renderChip(chip) {
                        ...
                        renderedChip.setAttribute("persona_id", chip.id);
                    ...
                    value: function _setupAutocomplete() {
                        ...
                        this.options.autocompleteOptions.onAutocomplete = function(val, id) {
                            //MATCAT - CUSTOMIZE MATERIALIZE PER SUPPORTARE 'ID' IN AUTOCOMPLETE 
                            _this46.addChip({
                                tag: val,
                                id: id
            ...
            [
                {
                    key: "init",
                    value: function init(els, options) {
                        return _get(Chips.__proto__ || Object.getPrototypeOf(Chips), "init", this)
                            .call(this, this, els, options);
                    }
...
(function($) {
    ...
    var Pushpin = function(_Component13) {
        ...
        function Pushpin(el, options) {
            ...
            var _this47 = _possibleConstructorReturn(this,
            ...
            [
                {
                    key: "init",
                    value: function init(els, options) {
                        return _get(Pushpin.__proto__ || Object.getPrototypeOf(Pushpin), "init", this)
                            .call(this, this, els, options);
                    }
...
(function($, anim) {
    ...
    var FloatingActionButton = function(_Component14) {
        ...
        function FloatingActionButton(el, options) {
            ...
            var _this48 = _possibleConstructorReturn(this,
                (FloatingActionButton.__proto__ || Object.getPrototypeOf(FloatingActionButton)).call(this,
            ...
            [
                {
                    key: "init",
                    value: function init(els, options) {
                        return _get(FloatingActionButton.__proto__ || Object.getPrototypeOf(FloatingActionButton),
                            "init",
...
(function($) {
    ...
    var Datepicker = function(_Component15) {
        ...
        function Datepicker(el, options) {
            ...
            var _this53 = _possibleConstructorReturn(this,
                    ...
                    value: function gotoDate(date) {
                        ...
                        if (this.calendars) {
                            var firstVisibleDate = new Date(this.calendars[0].year, this.calendars[0].month, 1),
                                lastVisibleDate = new Date(this.calendars[this.calendars.length - 1].year,
            ...
            [
                {
                    key: "init",
                    value: function init(els, options) {
                        return _get(Datepicker.__proto__ || Object.getPrototypeOf(Datepicker), "init", this)
                            .call(this, this, els, options);
                    }
                }, {
                    key: "_isDate",
                    ...
                    value: function _getDaysInMonth(year, month) {
                        return [
                            31, Datepicker._isLeapYear(year) ? 29 : 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31
                        ][month];
                    }
                }, {
                    key: "_isLeapYear",
    ...
    Datepicker._template = [
        '<div class= "modal datepicker-modal">', '<div class="modal-content datepicker-container">',
        '<div class="datepicker-date-display">', '<span class="year-text"></span>', '<span class="date-text"></span>',
        "</div>", '<div class="datepicker-calendar-container">', '<div class="datepicker-calendar"></div>',
        '<div class="datepicker-footer">',
        '<button class="btn-flat datepicker-clear waves-effect" style="visibility: hidden;" type="button"></button>',
        '<div class="confirmation-btns">',
        '<button class="btn-flat datepicker-cancel waves-effect" type="button"></button>',
        '<button class="btn-flat datepicker-done waves-effect" type="button"></button>', "</div>", "</div>", "</div>",
        "</div>", "</div>"
    ].join("");
...
(function($) {
    ...
    var Timepicker = function(_Component16) {
        ...
        function Timepicker(el, options) {
            ...
            var _this57 = _possibleConstructorReturn(this,
                    ...
                    value: function _pickerSetup() {
                        var $clearBtn =
                            $(
                                ...
                                "</button>").appendTo(this.footer).on("click", this.clear.bind(this));
                        if (this.options.showClearBtn) {
                        ...
                        $('<button class="btn-flat timepicker-close waves-effect" type="button" tabindex="' +
                            ...
                            "</button>").appendTo(confirmationBtnsContainer).on("click", this.close.bind(this));
                        $('<button class="btn-flat timepicker-close waves-effect" type="button" tabindex="' +
                            (this.options.twelveHour ? "3" : "1") +
                            '">' +
                            this.options.i18n.done +
                            "</button>").appendTo(confirmationBtnsContainer).on("click", this.done.bind(this));
            ...
            [
                {
                    key: "init",
                    value: function init(els, options) {
                        return _get(Timepicker.__proto__ || Object.getPrototypeOf(Timepicker), "init", this)
                            .call(this, this, els, options);
                    }
                }, {
                    key: "_addLeadingZero",
    ...
    Timepicker._template = [
        '<div class= "modal timepicker-modal">', '<div class="modal-content timepicker-container">',
        '<div class="timepicker-digital-display">', '<div class="timepicker-text-container">',
        '<div class="timepicker-display-column">', '<span class="timepicker-span-hours text-primary"></span>', ":",
        '<span class="timepicker-span-minutes"></span>', "</div>",
        '<div class="timepicker-display-column timepicker-display-am-pm">', '<div class="timepicker-span-am-pm"></div>',
        "</div>", "</div>", "</div>", '<div class="timepicker-analog-display">', '<div class="timepicker-plate">',
        '<div class="timepicker-canvas"></div>', '<div class="timepicker-dial timepicker-hours"></div>',
        '<div class="timepicker-dial timepicker-minutes timepicker-dial-out"></div>', "</div>",
        '<div class="timepicker-footer"></div>', "</div>", "</div>", "</div>"
    ].join("");
...
(function($) {
    ...
    var CharacterCounter = function(_Component17) {
        ...
        function CharacterCounter(el, options) {
            ...
            var _this61 = _possibleConstructorReturn(this,
                (CharacterCounter.__proto__ || Object.getPrototypeOf(CharacterCounter)).call(this,
                    CharacterCounter,
                    el,
                    options));
            ...
            [
                {
                    key: "init",
                    value: function init(els, options) {
                        return _get(CharacterCounter.__proto__ || Object.getPrototypeOf(CharacterCounter), "init", this)
                            .call(this, this, els, options);
                    }
...
(function($) {
    ...
    var Carousel = function(_Component18) {
        ...
        function Carousel(el, options) {
            ...
            var _this62 = _possibleConstructorReturn(this,
            ...
            _this62.dim =
                _this62.itemWidth * 2 + _this62.options.padding || 1; // Make sure dim is non zero for divisions.
            ...
            [
                {
                    key: "init",
                    value: function init(els, options) {
                        return _get(Carousel.__proto__ || Object.getPrototypeOf(Carousel), "init", this)
                            .call(this, this, els, options);
                    }
...
(function($) {
    ...
    var TapTarget = function(_Component19) {
        ...
        function TapTarget(el, options) {
            ...
            var _this67 = _possibleConstructorReturn(this,
            ...
            [
                {
                    ...
                    value: function _calculatePositioning() {
                        ...
                        tapTargetWrapperCssObj.right =
                            isRight ? windowWidth - tapTargetLeft - tapTargetWidth + "px" : "";
                        tapTargetWrapperCssObj.bottom =
                            isBottom ? windowHeight - tapTargetTop - tapTargetHeight + "px" : "";
            ...
            [
                {
                    key: "init",
                    value: function init(els, options) {
                        return _get(TapTarget.__proto__ || Object.getPrototypeOf(TapTarget), "init", this)
                            .call(this, this, els, options);
                    }
...
(function($) {
    ...
    var FormSelect = function(_Component20) {
        ...
        function FormSelect(el, options) {
            ...
            var _this68 = _possibleConstructorReturn(this,
            ...
            [
                {
                    ...
                    value: function _setupDropdown() {
                        ...
                        $(this.dropdownOptions).addClass("dropdown-content select-dropdown " +
                        ...
                        if (this.$selectOptions.length) {
                            this.$selectOptions.each(function(el) {
                                if ($(el).is("option")) {
                                    ...
                                    $(_this71.dropdownOptions).append($('<li class="optgroup"><span>' +
                                        el.getAttribute("label") +
                                        "</span></li>")[0]);

                                    selectOptions.each(function(el) {
                                        var optionEl =
                                            _this71._appendOptionWithIcon(_this71.$el, el, "optgroup-option");
                                        _this71._addOptionToValueDict(el, optionEl);
                                    });
                                }
                            });
            ...
            [
                {
                    key: "init",
                    value: function init(els, options) {
                        return _get(FormSelect.__proto__ || Object.getPrototypeOf(FormSelect), "init", this)
                            .call(this, this, els, options);
                    }
...
(function($, anim) {
    ...
    var Range = function(_Component21) {
        ...
        function Range(el, options) {
            ...
            var _this72 = _possibleConstructorReturn(this,
            ...
            [
                {
                    key: "init",
                    value: function init(els, options) {
                        return _get(Range.__proto__ || Object.getPrototypeOf(Range), "init", this)
                            .call(this, this, els, options);
                    }
