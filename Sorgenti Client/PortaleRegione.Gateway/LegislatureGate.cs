...
{
    public class LegislatureGate:BaseGateway
    {
        static  LegislatureGate _instance;  
   
        public static LegislatureGate Instance => _instance ?? (_instance = new LegislatureGate());

        private LegislatureGate()
        {
